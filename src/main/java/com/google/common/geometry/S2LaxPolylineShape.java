...
public interface S2LaxPolylineShape extends S2ShapeAspect.EdgeAspect.Open {
  ...
  static class SimpleArray extends Simple.Array implements S2LaxPolylineShape {
  ...
  static class SimpleList extends Simple implements S2LaxPolylineShape {
  ...
  static class SimplePacked extends Simple.Packed implements S2LaxPolylineShape {
  ...
  static class SimpleSnapped extends Simple.Snapped implements S2LaxPolylineShape {
